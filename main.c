...
// user-defined types
#define COLMUN_USERNAME_SIZE 32
#define COLMUN_EMAIL_SIZE 255
...
{
    uint32_t id;
    char username[COLMUN_USERNAME_SIZE];
...
// define the attribtue of the struct
...
ExecuteResult execute_select(Statement* statemnet, Table* table){
    Row row;
